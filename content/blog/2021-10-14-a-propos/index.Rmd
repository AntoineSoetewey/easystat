...
categories: []
tags: []
featureImage: images/blog/Antoine-Soetewey-easystat-prof-stat.png
postImage: images/blog/Antoine-Soetewey-easystat-prof-stat.png
---

Ci-dessous vous trouverez une présentation sous forme d'interview (réalisée par Superprof).
...
Tous les thèmes en statistiques sont intéressants et aucun ne me déplait. Cependant, il est vrai que j'aime particulièrement donner des cours de stats portant sur les [stats descriptives](https://statsandr.com/blog/descriptive-statistics-in-r/), [probabilités](https://statsandr.com/blog/the-9-concepts-and-formulas-in-probability-that-every-data-scientist-should-know/), variables aléatoires et distributions, intervalles de confiance, [tests d'hypothèses](https://statsandr.com/blog/hypothesis-test-by-hand/) et [régressions linéaires](https://statsandr.com/blog/multiple-linear-regression-made-simple/).

Étant donné que j'utilise le programme statistique R pour mes recherches dans le cadre de ma thèse, j'aime aussi particulièrement enseigner des cours pratiques ou donner des formations sur ce programme.
...
C'est aussi ce que je m'éfforce de faire lorsque j'écrit sur mon blog [Stats and R](https://statsandr.com/)---communiquer des concepts statistiques de manière claire, concise et aussi précise que possible.
...
Une chose intéressante est que mon doctorat est en biostatistique (qui est en quelques mots des méthodes statistiques appliquées au monde médical et/ou biologique, voir plus au travers de mes [recherches](https://antoinesoetewey.com/fr/research/) si cela vous intéresse). Heureusement, ces difficultés en bio sont loin derrière moi maintenant.
...
Pendant mon temps libre, j'adore également [lire](https://antoinesoetewey.com/files/booklist.html) des livres de non-fiction en statistiques, économie (comportementale entre autres), investissement/finances personnelles ou en psychologie et apprendre à coder au travers de mon [blog](https://statsandr.com/).

Comme beaucoup de personnes, j'aime aussi [voyager](https://antoinesoetewey.com/files/visited-places.html) et découvrir de nouvelles cultures et de nouveaux horizons.
...
Le fait que j'aide également les non-étudiants et sociétés pour l'[analyse de leur données](https://datanalyze.be/) me permet de donner des exemples concrets et pratiques à mes étudiants, ce qui est souvent très apprécié. 

De plus, j'aime partager mes connaissances et faire en sorte que les étudiants comprennent ce qu'ils font pour ensuite pouvoir apprendre par eux-mêmes et continuer de progresser. Ceci est très important pour leur développement et apprentissage une fois que les cours sont terminés.

**9. Quelle est votre méthode d'enseignement?**

Ma méthode d'enseignement est différente que vous ayez besoin d'aide pour la partie statistique de votre mémoire/TFE, ou de cours particuliers.

Il serait difficile d'expliquer cela en quelques lignes seulement. Vous trouverez toutes les informations concernant ma méthode d'enseignement au travers de cet [article](/blog/methode-enseignement/).

**En savoir plus**

Vous trouverez plus d'informations me concernant sur mon [site personnel](https://antoinesoetewey.com/fr/).