...
Dès lors, je vous invite à vous entourer de personnes qui sont expertes dans les domaines liés aux vôtres et qui sont disponibles pour donner cours.
...
Cela va de soi, vous aurez besoin au minimum d'une table, des chaises et de quoi écrire. En plus de cela, je conseille :
...
- Si je peux aider l'étudiant, au lieu de faire des va-et-vient par e-mail pour trouver un créneau qui nous convienne à tous les deux, j'utilise Calendly; un outil de prise de rendez-vous en ligne (voir [ma page Calendly](https://calendly.com/antoinesoetewey) en guise d'exemple). En plus de permettre à n'importe qui de prendre rendez-vous quand cela lui arrange le mieux, cet outil peut aussi :
  + Être synchronisé avec votre agenda : donc si vous créer un événement autre qu'un cours, cette plage horaire ne sera plus disponible pour vos étudiants.
...
En effet, restreindre le nombre de cours permet de ne sélectionner que ceux dont on maitrise le mieux le sujet. Ceci augmente fortement la qualité des cours, et à la suite de cela vos étudiants vont d'autant plus vous recommander.
