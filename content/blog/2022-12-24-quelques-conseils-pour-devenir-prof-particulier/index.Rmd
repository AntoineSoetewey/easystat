...
Au travers de cet article, je donne 7 conseils :

- à toutes les personnes qui voudraient commencer à donner des cours particuliers, ou
- les personnes qui le font déjà mais qui voudraient y consacrer plus de temps et se professionnaliser.

Chaque prof est différent et aborde la matière différement, et ce même différement en fonction de chaque étudiant et de ses besoins. Je ne vais donc évidemment pas donner des conseils sur comment donner cours, mais plutôt sur des aspects pratiques et logistiques.
...
Le troisième critère concerne votre tarif horaire. Là aussi vous l'aurez deviné, plus votre prix horaire est élevé, au moins vous serez placé en haut de page.
...
Je suis le premier à penser que tout travail mérite salaire. Cependant, pour le vivre tous les jours, je remarque aussi que la qualité de mes cours dépend de mon expérience à enseigner cette matière.
...
Je conseille d'éviter de vouloir gagner plus, trop rapidement. En effet, les étudiants qui paient un prix élevé ont également tendance à avoir des exigences plus élevées et s'attendent à des cours de meilleurs qualité. Si votre prestation n'est pas à la hauteur de leurs espérances, ils auront moins tendances à vous donner une bonne évaluation.

Si vous donnez des cours sur un horizon à long terme, vous aurez bien le temps d'augmenter vos prix quand vous aurez acquis plus d'expérience, récolté plus de bonnes évaluations et construit une certaine réputation auprès des étudiants.
...
Lorsque je refuse une demande de cours parce que cela sort de mon domaine d'expertise, je suis transparent avec l'étudiant et je lui donne très souvent les e-mails de mes collègues statisticiens pour qu'ils puissent les contacter, s'ils le désirent (voir [ma liste](/profs/) en guise d'exemple).

Dès lors, je vous invite à vous entourer de personnes qui sont expertes dans les domaines liés aux votres et qui sont disponibles pour donner cours.
...
De plus, on apprend énormément en donnant cours à des étudiants venant de programmes d'étude différents. Par conséquent, je pense qu'il est bien de garder un certain nombre de cours légèrement au-dessus de nos capacités, tant que la préparation préalable reste raisonnable.
...
Cela va de soit, vous aurez besoin au minimum d'une table, des chaises et de quoi écrire. En plus de cela, je conseille :
...
- une bonne connection internet (il n'y a rien de plus dérangeant qu'une conversation qui est sans cesse coupée), et
- une tablette et un stylet.

Je conseille une tablette pour que vous puissiez écrire à la main et partager votre écran à l'étudiant (essayez de résoudre un exercice de statistique avec juste un ordinateur...).
...
1. Demander à l'étudiant de m'envoyer la matière qu'il désire revoir avec moi s'il ne le fait pas de lui même (et d'expérience, peu le font)
...
Comme vous pouvez le voir, à partir d'un certain nombre d'étudiants, ces étapes peuvent vite vous faire perdre beaucoup de temps. Je conseille donc d'automatiser au maxmimum tout ce qui est possible.
...
Par contre, avec le temps j'ai appris que certaines étapes peuvent être vraiment facilitées grâce à quelques outils ou procédés. Voici ceux que j'utilise le plus souvent, et qui me font gagner le plus de temps :

- Dès qu'un étudiant me contacte, je le renvoie vers ce [questionnaire de prise de contact](/contact/) qui me permet de récolter toutes les informations nécessaires en une seule fois. Sur ce questionnaire, je rappelle également à l'étudiant de m'envoyer la matière, sans quoi je ne sais pas vérifier si la matière est dans mes cordes ou non. Pour ce questionnaire, j'utilise [Airtable](https://airtable.com/invite/r/T00stCNz), mais il peut tout à fait être créé sur Google Forms par exemple.^[J'utilise Airtable plutôt que Google parce qu'Airtable est plus complet; il permet notamment de lier des questionnaires avec des tables hautement personnalisables et les intégrer avec d'autres plateformes, etc. De plus, ils proposent une application mobile intuitive et un plan gratuit qui est largement suffisant pour débuter.]
- Si je peux aider l'étudiant, au lieu de faire des va-et-vient par e-mail pour trouver un créneau qui nous convienne à tous les deux, j'utilise Calendly; un outil de prise de rendez-vous en ligne (voir [ma page Calendly](https://calendly.com/antoinesoetewey) en guise d'exemple). En plus de permettre à n'importe qui de prendre rendez-vous quand cela lui arrange le mieux, cet outil peut aussi :
  + Etre synchronisé avec votre agenda : donc si vous créer un événement autre qu'un cours, cette plage horaire ne sera plus disponible pour vos étudiants.
  + Etre synchronisé avec votre compte Teams : lorsqu'un étudiant réserve une plage horaire, une réunion Teams est créée et un lien vers la réunion est envoyée par email (tout ceci automatiquement, sans aucune action de ma part).
...
- Certains des e-mails ou messages que j'envoie aux étudiants se répètent. Pour gagner du temps, j'ai créé une note sur mon ordinateur qui reprend tous les messages et réponses types. Dès que possible, je fais un copier-coller plutôt que de l'écrire entièrement (ceci évite aussi des erreurs de frappe ou d'oublier une partie des informations).
...
En effet, restreindre le nombre de cours permet de ne séléctionner que ceux dont on maitrise le mieux le sujet. Ceci augmente fortement la qualité des cours, et à la suite de cela vos étudiants vont d'autant plus vous recommander.
